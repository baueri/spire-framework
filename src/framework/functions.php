...
use Baueri\Spire\Framework\File\Path;
use Baueri\Spire\Framework\Http\ApiResponse;
use Baueri\Spire\Framework\Http\Message;
...
use Baueri\Spire\Framework\Http\View\View;
use Baueri\Spire\Framework\Http\View\ViewInterface;
...
/**
 * @param string $route
 * @param array|string|Entity $args
 * @param bool $withHost
 * @return string
 */
