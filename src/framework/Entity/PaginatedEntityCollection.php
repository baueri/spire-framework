...
use Baueri\Spire\Framework\Database\PaginatedResultSetInterface;

class PaginatedEntityCollection extends EntityCollection implements PaginatedResultSetInterface
{
    protected int $page;
